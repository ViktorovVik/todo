...
function addTask(event) {
   // Отменяю стандартное поведение отправки формы
...
// Если клик был НЕ по кнопке "удалить задачу"
   ...
   // Удаляю задачу через фильрацию масства
...
function doneTask(event) {
   // Проверяю, что клик был НЕ по кнопке "задача выполнена"
...
function renderTask(task) {
   ...
   // Формирую разметку для новой задачи 
